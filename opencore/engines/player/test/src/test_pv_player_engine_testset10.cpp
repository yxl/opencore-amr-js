...
//
// pvplayer_async_test_genericdelete section
//
...
void pvplayer_async_test_genericdelete::StartTest()
{
    AddToScheduler();
    iState = STATE_CREATE;
    RunIfNotReady();
...
void pvplayer_async_test_genericdelete::Run()
{
    int error = 0;
...
void pvplayer_async_test_genericdelete::CommandCompleted(const PVCmdResponse& aResponse)
{
...
void pvplayer_async_test_genericdelete::HandleErrorEvent(const PVAsyncErrorEvent& aEvent)
{
...
void pvplayer_async_test_genericdelete::HandleRTSPNodeErrors(int32 aErr)
{
...
void pvplayer_async_test_genericdelete::HandleStreamingManagerNodeErrors(int32 aErr)
{
...
void pvplayer_async_test_genericdelete::HandleJitterBufferNodeErrors(int32 aErr)
{
...
void pvplayer_async_test_genericdelete::HandleMediaLayerNodeErrors(int32 aErr)
{
...
void pvplayer_async_test_genericdelete::HandleProtocolEngineNodeErrors(int32 aErr)
{
...
void pvplayer_async_test_genericdelete::PrintMetadataInfo()
{
    uint32 i = 0;
