...
//
// pvplayer_async_test_genericreset section
//
...
void pvplayer_async_test_genericreset::StartTest()
{
    AddToScheduler();
    iState = STATE_CREATE;
    RunIfNotReady();
...
void pvplayer_async_test_genericreset::Run()
{
    int error = 0;
...
void pvplayer_async_test_genericreset::CommandCompleted(const PVCmdResponse& aResponse)
{
...
void pvplayer_async_test_genericreset::HandleErrorEvent(const PVAsyncErrorEvent& aEvent)
{
...
void pvplayer_async_test_genericreset::HandleRTSPNodeErrors(int32 aErr)
{
...
void pvplayer_async_test_genericreset::HandleStreamingManagerNodeErrors(int32 aErr)
{
...
void pvplayer_async_test_genericreset::HandleJitterBufferNodeErrors(int32 aErr)
{
...
void pvplayer_async_test_genericreset::HandleMediaLayerNodeErrors(int32 aErr)
{
...
void pvplayer_async_test_genericreset::HandleProtocolEngineNodeErrors(int32 aErr)
{
...
void pvplayer_async_test_genericreset::HandleInformationalEvent(const PVAsyncInformationalEvent& aEvent)
{
    ...
    switch (aEvent.GetEventType())
    {
        ...
        case PVMFInfoBufferingComplete:
            ...
            // There should be only one buffer complete
...
void pvplayer_async_test_genericreset::PrintMetadataInfo()
{
    uint32 i = 0;
