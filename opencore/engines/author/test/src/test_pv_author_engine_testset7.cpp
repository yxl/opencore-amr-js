...
void pv_mediainput_async_test_reset::StartTest()
{
    AddToScheduler();
...
////////////////////////////////////////////////////////////////////////////
void pv_mediainput_async_test_reset::HandleErrorEvent(const PVAsyncErrorEvent& aEvent)
{
    OSCL_UNUSED_ARG(aEvent);
    PVLOGGER_LOGMSG(PVLOGMSG_INST_REL, iLogger, PVLOGMSG_ERR, (0, "pv_mediainput_async_test_reset::HandleErrorEvent"));
...
////////////////////////////////////////////////////////////////////////////
bool pv_mediainput_async_test_reset::CreateTestInputs()
{
    int32 status = 0;
    int32 error = 0;
    iFileParser = NULL;
...
////////////////////////////////////////////////////////////////////////////
bool pv_mediainput_async_test_reset::ConfigComposer()
{
    if (!ConfigOutputFile())
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_ERR,
                        (0, "pv_mediainput_async_test_reset::ConfigComposer: Error - ConfigOutputFile failed"));
    ...
    if ((oscl_strstr(iComposerMimeType.get_str(), "mp4")) || (oscl_strstr(iComposerMimeType.get_str(), "3gp")))
    {
        ...
        {
            PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_ERR,
                            (0, "pv_mediainput_async_test_reset::ConfigComposer: Error - ConfigMp43gpComposer failed"));
...
////////////////////////////////////////////////////////////////////////////
bool pv_mediainput_async_test_reset::ConfigOutputFile()
{
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_ERR,
                        (0, "pv_mediainput_async_test_reset::ConfigOutputFile: Error - Invalid iComposerConfig"));
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_ERR,
                        (0, "pv_mediainput_async_test_reset::ConfigOutputFile: Error - SetOutputFileName failed"));
...
////////////////////////////////////////////////////////////////////////////
bool pv_mediainput_async_test_reset::ConfigMp43gpComposer()
{
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_ERR,
                        (0, "pv_mediainput_async_test_reset::ConfigMp43gpComposer: Error - iComposerConfig==NULL"));
...
////////////////////////////////////////////////////////////////////////////
bool pv_mediainput_async_test_reset::AddMediaTrack()
{
...
bool pv_mediainput_async_test_reset::ConfigureVideoEncoder()
{
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_DEBUG,
                        (0, "pv_mediainput_async_test_reset::ConfigureVideoEncoder: No configuration needed"));
...
////////////////////////////////////////////////////////////////////////////
void pv_mediainput_async_test_reset::Cleanup()
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_DEBUG, (0, "pv_mediainput_async_test_reset::Cleanup"));
...
////////////////////////////////////////////////////////////////////////////
void pv_mediainput_async_test_reset::Run()
{
    ...
    switch (iState)
    {
        ...
        {
            PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_DEBUG,
                            (0, "******pv_mediainput_async_test_reset::iTestCaseNum:%d******", iTestCaseNum));
        ...
        case PVAE_CMD_ADD_DATA_SOURCE:
        {
            ...
            {
                PVLOGGER_LOGMSG(PVLOGMSG_INST_REL, iLogger, PVLOGMSG_ERR,
                                (0, "pv_mediainput_async_test_reset::CreateTestInputs: Error - failed"));
        ...
        {
            PVLOGGER_LOGMSG(PVLOGMSG_INST_REL, iLogger, PVLOGMSG_ERR,
                            (0, "pv_mediainput_async_test_reset::Run: Command Stop"));
...
////////////////////////////////////////////////////////////////////////////
void pv_mediainput_async_test_reset::CommandCompleted(const PVCmdResponse& aResponse)
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE,
                    (0, "pv_mediainput_async_test_reset::CommandCompleted iState:%d", iState));
    ...
    switch (iState)
    {
        ...
        case PVAE_CMD_SELECT_COMPOSER:
        {
            if (aResponse.GetCmdStatus() == PVMFSuccess)
            {
                ...
                {
                    PVLOGGER_LOGMSG(PVLOGMSG_INST_REL, iLogger, PVLOGMSG_ERR,
                                    (0, "pv_mediainput_async_test_reset::CommandCompleted: Error - ConfigComposer failed"));
