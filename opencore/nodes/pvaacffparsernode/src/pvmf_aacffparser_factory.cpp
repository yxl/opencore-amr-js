 ...
 */
/**
 * @file pvmf_aacffparser_factory.cpp
 * @brief Singleton factory for PVMFAACFFParserNode
 */
...
////////////////////////////////////////////////////////////////////////////
OSCL_EXPORT_REF bool PVMFAACFFParserNodeFactory::DeletePVMFAACFFParserNode(PVMFNodeInterface* aNode)
{
    if (aNode)
    {
        OSCL_DELETE(aNode);
